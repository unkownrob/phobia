...
Library:Notification("Loaded paradox in " .. Floor((tick() - loadingTime) * 1000)  .."ms", 3, Library.Accent, flags["Notification Position"])
Library:Notification("Developers: yhhrobfr tykangel " .. Floor((tick() - loadingTime) * 10000)  .."ms", 3, Library.Accent, flags["Notification Position"])
